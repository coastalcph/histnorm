...
def main(args):
    ...
    multicount = sum(1 for translations in europarl.values() if len(translations) == len(args.languages))
    print("Found {:8d} lines that appear in all languages.".format(multicount))

    outfile = {lang: open("extracted.multi.{}".format(lang), 'w')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dir',
                        default='.',
                        type=str,
                        help='Directory for Europarl files')
